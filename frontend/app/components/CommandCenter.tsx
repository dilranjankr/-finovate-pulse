                ...
                : tdList.rows.length === 0 ? <div className="empty-s" style={{ padding: 24 }}>No tasks in this bucket</div> : (
                  <div className="scrollwrap" style={{ maxHeight: 460 }}>
                    <table className="hd-table">
                      <thead><tr><th className="l">Task</th><th className="l">Client</th><th className="l">Assignees</th><th>Tracked</th><th>Due</th><th>Completed</th><th className="l">Status</th></tr></thead>
                      <tbody>
                        {tdList.rows.map((r, i) => (
                          <tr key={i}>
